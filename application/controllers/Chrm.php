...
// State Income Tax - Report - Madhu
    ...
    public function stateIncomeReportData() {
        ...
        $livingStateTaxReport         = $this->Hrm_model->living_state_tax_report($employee_name, $taxname, $date, $decodedId);
...
// public function state_tax_search() {
    ...
    public function UC_2a_form($quarter = null) {
        ...
        $data['info_for_nj']    = $this->Hrm_model->info_for_nj($quarter, $id);
    ...
    public function employee_payslip_permission() {
        ...
        foreach ($all_overtime as $time) {
            if ($time > $data['extratime_info'][0]['work_hour']) {
