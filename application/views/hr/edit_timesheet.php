                        ...
                        <div class="table-responsive work_table col-md-12">
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="PurList"> 
                                ...
                                <tr>
                                    ...
                                    <td class="start-time">
                                        <input <?php if ($timesheetdata[$date]['edit'] == 1) { echo 'readonly'; } ?> name="start[]" data-id='<?php echo $data_id;  ?>' class="hasTimepicker start" value="<?= empty($timesheetdata[$date]['day']) ? 'readonly' : $timesheetdata[$date]['start']; ?>" type="time">
                                    </td>
                                    <td class="finish-time">
                                        <input <?php if ($timesheetdata[$date]['edit'] == 1) { echo 'readonly'; } ?> name="end[]" data-id='<?php echo $data_id;  ?>' class="hasTimepicker end" value="<?= empty($timesheetdata[$date]['day']) ? 'readonly' : $timesheetdata[$date]['end']; ?>" type="time">
                                    </td>
