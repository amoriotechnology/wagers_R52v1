                 ...
                 name="above_extra_beforehours" />
                   ...
                   <?php } ?>
                              ...
                              <?php  if($employee_name[0]['payroll_type']=='Hourly') {
                                ...
                                ?>
                                 <input type="text" id="extra_hour" name="extra_hour" value="<?php echo ($total_hours_numeric > $work_hour_numeric) ? ($overtime) : '0'; ?>" />
                                 ...
                                 <input type="text" id="extra_this_hour" name="extra_this_hour" value="<?php echo $overtime; ?>" />
                                 <input type="text" id="extra_ytd" name="extra_ytd" value="<?php echo  $total_cost; ?>"   />
                                 <?php    } else{ 
                                    list($hours, $minutes) = explode(':', $overtime);
